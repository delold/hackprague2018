...
var EventRegistry = /** @class */ (function () {
    ...
    EventRegistry.prototype.jsonRequestAnalytics = function (path, parameters) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var request, error_1;
            return __generator(this, function (_a) {
    ...
    EventRegistry.prototype.suggestNewsSources = function (prefix, args) {
        if (args === void 0) { args = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, page, _b, count, _c, dataType, request;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = args.page, page = _a === void 0 ? 1 : _a, _b = args.count, count = _b === void 0 ? 20 : _b, _c = args.dataType, dataType = _c === void 0 ? ["news", "pr"] : _c;
                        if (page <= 0) {
                            throw new RangeError("page parameter should be above 0");
                        }
                        return [4 /*yield*/, this.jsonRequest("/json/suggestSources", { prefix: prefix, page: page, dataType: dataType, count: count })];
                    case 1:
                        request = _d.sent();
                        return [2 /*return*/, request.data];
                }
    ...
    EventRegistry.prototype.getNewsSourceUri = function (sourceName, dataType) {
        if (dataType === void 0) { dataType = ["news", "pr"]; }
        return __awaiter(this, void 0, void 0, function () {
            var matches;
            return __generator(this, function (_a) {
                switch (_a.label) {
