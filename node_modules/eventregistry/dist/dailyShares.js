...
var GetTopSharedArticles = /** @class */ (function (_super) {
    ...
    function GetTopSharedArticles(args) {
        ...
        _this.setVal("resultType", "articles");
        _this.setVal("articlesCount", count);
        _this.setVal("articlesSortBy", "socialScore");
        _this.setDateVal("dateStart", date);
        _this.setDateVal("dateEnd", date);
        _this.params = _.extend({}, _this.params, returnInfo.getParams("articles"));
        return _this;
    }
    Object.defineProperty(GetTopSharedArticles.prototype, "path", {
        get: function () {
            return "/json/article";
        },
        enumerable: true,
...
var GetTopSharedEvents = /** @class */ (function (_super) {
    ...
    function GetTopSharedEvents(args) {
        ...
        _this.setVal("resultType", "events");
        _this.setVal("eventsCount", count);
        _this.setVal("eventsSortBy", "socialScore");
        _this.setDateVal("dateStart", date);
        _this.setDateVal("dateEnd", date);
        _this.params = _.extend({}, _this.params, returnInfo.getParams("events"));
        return _this;
    }
    Object.defineProperty(GetTopSharedEvents.prototype, "path", {
        get: function () {
            return "/json/event";
        },
        enumerable: true,
