...
var Analytics = /** @class */ (function () {
     ...
     */
    Analytics.prototype.annotate = function (text, lang) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = _).get;
                        return [4 /*yield*/, this.er.jsonRequestAnalytics("/api/v1/annotate", { lang: lang, text: text })];
     ...
     */
    Analytics.prototype.categorize = function (text) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = _).get;
                        return [4 /*yield*/, this.er.jsonRequestAnalytics("/api/v1/categorize", { text: text })];
                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent(), "data"])];
                }
            });
        });
     ...
     * @param text input text to categorize
     */
    Analytics.prototype.sentiment = function (text) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = _).get;
                        return [4 /*yield*/, this.er.jsonRequestAnalytics("/api/v1/sentiment", { text: text })];
                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent(), "data"])];
                }
            });
        });
     ...
     */
    Analytics.prototype.extractArticleInfo = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = _).get;
                        return [4 /*yield*/, this.er.jsonRequestAnalytics("/api/v1/extractArticleInfo", { url: url })];
                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent(), "data"])];
                }
            });
        });
